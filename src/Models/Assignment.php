...
/**
 * A person's commitment to one task, and how it turned out.
 */
final class Assignment
{
    ...
    /**
     * Whether this row still holds a slot in its task. A no-show keeps its
     * row for the reputation history but has stopped occupying the task.
     */
